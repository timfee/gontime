       // 1. One hour meeting with Google Meet (in progress)
            EventRow(
                event: GoogleEvent(
                    ...
                    start: EventDateTime(dateTime: currentHour, date: nil),
                        ...
                        dateTime: currentHour.addingTimeInterval(3600), date: nil),
                    attendees: [],
            ...
            EventRow(
                event: GoogleEvent(
                    ...
                    summary: "Design Sync",
                    start: EventDateTime(
                        dateTime: currentHour.addingTimeInterval(5400), date: nil),
                    end: EventDateTime(
            ...
            EventRow(
                event: GoogleEvent(
                    ...
                    start: EventDateTime(
                        dateTime: currentHour.addingTimeInterval(8100), date: nil),
                    end: EventDateTime(
            ...
            EventRow(
                event: GoogleEvent(
                    ...
                    start: EventDateTime(
                        dateTime: currentHour.addingTimeInterval(9000), date: nil),
                    end: EventDateTime(
